...
xilinx.com:user:zybo_accel_ctrl:1.0\
...
\
  ...
  # Create instance: zybo_accel_ctrl_0, and set properties
  set zybo_accel_ctrl_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:zybo_accel_ctrl:1.0 zybo_accel_ctrl_0 ]
  ...
  # Create instance: aes_ctr_block_128_0, and set properties
  set block_name aes_ctr_block_128
  set block_cell_name aes_ctr_block_128_0
  if { [catch {set aes_ctr_block_128_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $aes_ctr_block_128_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net aes_ctr_block_128_0_m_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins aes_ctr_block_128_0/m_axis]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins aes_ctr_block_128_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins zybo_accel_ctrl_0/S00_AXI]
  ...
  connect_bd_net -net aes_ctr_block_128_0_aes_ctr_idle  [get_bd_pins aes_ctr_block_128_0/aes_ctr_idle] \
  [get_bd_pins zybo_accel_ctrl_0/aes_ctr_idle]
  ...
  [get_bd_pins aes_ctr_block_128_0/reset_n] \
  [get_bd_pins zybo_accel_ctrl_0/s00_axi_aresetn]
  ...
  [get_bd_pins aes_ctr_block_128_0/clk] \
  [get_bd_pins zybo_accel_ctrl_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N  [get_bd_pins processing_system7_0/FCLK_RESET0_N] \
  [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net zybo_accel_ctrl_0_aes_ctr_start  [get_bd_pins zybo_accel_ctrl_0/aes_ctr_start] \
  [get_bd_pins aes_ctr_block_128_0/aes_ctr_start]
  connect_bd_net -net zybo_accel_ctrl_0_aes_initial_counter_out  [get_bd_pins zybo_accel_ctrl_0/aes_initial_counter_out] \
  [get_bd_pins aes_ctr_block_128_0/initial_counter_in]
  connect_bd_net -net zybo_accel_ctrl_0_aes_key_out  [get_bd_pins zybo_accel_ctrl_0/aes_key_out] \
  [get_bd_pins aes_ctr_block_128_0/key_in]
  connect_bd_net -net zybo_accel_ctrl_0_aes_nonce_out  [get_bd_pins zybo_accel_ctrl_0/aes_nonce_out] \
  [get_bd_pins aes_ctr_block_128_0/nonce_in]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs zybo_accel_ctrl_0/S00_AXI/S00_AXI_reg] -force
